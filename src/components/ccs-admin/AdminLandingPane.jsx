      ...
      <section style={panel}>
        ...
        <div style={{ padding: 14 }}>
          <p style={{ margin: "0 0 10px", color: tm.muted, fontSize: 13, lineHeight: 1.55 }}>
            Edits persist in Neon (<code style={code}>ccs_site_settings</code> · key <code style={code}>landing</code>). The public homepage and forum rails read this payload; visitors pick up updates on the next poll. Include <code style={code}>badgeCatalog</code> (string array) for admin badge suggestions and <code style={code}>postTagOptions</code> (string array) for composer tag chips.
          </p>
